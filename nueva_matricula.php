        ...
        <?php if ($step == 'estudiante'): ?>
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <?php 
                    $fecha_mostrar = '';
                    if (!empty($data['estudiante']['fecha_nacimiento'])) {
                        // Si ya está en formato Y-m-d, convertir a d/m/Y
                        if (strpos($data['estudiante']['fecha_nacimiento'], '-') !== false) {
                            $fecha_mostrar = date('d/m/Y', strtotime($data['estudiante']['fecha_nacimiento']));
                        } else {
                            $fecha_mostrar = $data['estudiante']['fecha_nacimiento'];
                        }
                    }
                    ?>
